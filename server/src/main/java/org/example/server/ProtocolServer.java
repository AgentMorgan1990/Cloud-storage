...
//рефакторинг
//todo рефакторинг метода отправления файлов на серваке
//todo рефакторинг код на серваке (продумать о сокращении стейтов, навигация и создание/удаление используют схожие методы по получению имени файла) ++DONE
